...
namespace ResumeNET.Presentation.Console
{
    public class Program
    {
        private static void Main(string[] args)
        {
            ...
            Work work = new Work(WorkStateType.Company, "Apple Inc.", "Intern");
            work.Website = "apple.com";
            work.StartDate = "02-07-2018";
            work.EndDate = "03-09-2018";
            resume.Works.Add(work);

            Skill skill = new Skill("Object Oriented Programming", SkillLevelType.Average);
            resume.Skills.Add(skill);

            Language language = new Language("English", LanguageLevelType.UpperIntermediate);
            ...
            System.Console.WriteLine(resume.Write());
